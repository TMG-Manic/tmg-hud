...
function closeMenu() {
    ...
    $.post("https://tmg-hud/closeMenu");
}
function restartHud() {
    closeMenu();
    $.post("https://tmg-hud/restartHud");
}
function resetStorage() {
    closeMenu();
    $.post("https://tmg-hud/resetStorage");
}
function showOutMap() {
    $.post("https://tmg-hud/showOutMap");
}
function showOutCompass() {
    $.post("https://tmg-hud/showOutCompass");
}
function showFollowCompass() {
    $.post("https://tmg-hud/showFollowCompass");
}
function openMenuSounds() {
    $.post("https://tmg-hud/openMenuSounds");
}
function resetHudSounds() {
    $.post("https://tmg-hud/resetHudSounds");
}
function checklistSounds() {
    $.post("https://tmg-hud/checklistSounds");
}
function showMapNotif() {
    $.post("https://tmg-hud/showMapNotif");
}
function showFuelAlert() {
    $.post("https://tmg-hud/showFuelAlert");
}
function showCinematicNotif() {
    $.post("https://tmg-hud/showCinematicNotif");
}
function dynamicHealth() {
    $.post("https://tmg-hud/dynamicHealth");
}
function dynamicArmor() {
    $.post("https://tmg-hud/dynamicArmor");
}
function dynamicHunger() {
    $.post("https://tmg-hud/dynamicHunger");
}
function dynamicThirst() {
    $.post("https://tmg-hud/dynamicThirst");
}
function dynamicStress() {
    $.post("https://tmg-hud/dynamicStress");
}
function dynamicOxygen() {
    $.post("https://tmg-hud/dynamicOxygen");
}
function dynamicEngine() {
    $.post("https://tmg-hud/dynamicEngine");
}
function dynamicNitro() {
    $.post("https://tmg-hud/dynamicNitro");
}
function ToggleMapShape() {
    $.post("https://tmg-hud/ToggleMapShape");
}
function changeFPS() {
    $.post("https://tmg-hud/changeFPS");
}
function ToggleMapBorders() {
    $.post("https://tmg-hud/ToggleMapBorders");
}
function HideMap() {
    $.post("https://tmg-hud/HideMap");
}
function changeCompassFPS() {
    $.post("https://tmg-hud/changeCompassFPS");
}
function showCompassBase() {
    $.post("https://tmg-hud/showCompassBase");
}
function showStreetsNames() {
    $.post("https://tmg-hud/showStreetsNames");
}
function showPointerIndex() {
    $.post("https://tmg-hud/showPointerIndex");
}
function showDegreesNum() {
    $.post("https://tmg-hud/showDegreesNum");
}
function cinematicMode() {
    $.post("https://tmg-hud/cinematicMode");
}
